...
from agentaudit.analyzers import ScanContext, llm_analyzer
from agentaudit.analyzers.llm_analyzer import AiScanError, estimate_tokens
...
def test_ai_parses_valid_findings(monkeypatch):
    ...
    assert findings[0].rule_id == "AA-AI-000"
